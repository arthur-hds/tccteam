...
import arrow
from TCC.bibliotecas import atualizarDados, resetarRotinas, extrairMensagens
import ast
...
"background-color: rgba(255, 255, 255, 0);")
        ...
        self.caixaMensagens_3.setGeometry(QtCore.QRect(60, 120, 561, 41))
...
"}")
        ...
        self.label_57.setGeometry(QtCore.QRect(70, 440, 371, 49))
...
"background-color: rgba(255, 255, 255, 0);")
        ...
        self.listaMensagensSalvas_3.setGeometry(QtCore.QRect(70, 280, 621, 161))
        self.listaMensagensSalvas_3.doubleClicked.connect(self.eliminarItemListaMensagens)
...
"}")
        ...
        self.botaoAddVariaveis_3.setGeometry(QtCore.QRect(60, 170, 121, 21))
...
"}")
        ...
        self.botaoSalvar_3.setGeometry(QtCore.QRect(630, 110, 91, 41))
...
"}")
        ...
        self.listaVariaveis_3.setGeometry(QtCore.QRect(170, 160, 331, 61))
...
"}")
        ...
        self.widgetAddVariaveis.setGeometry(QtCore.QRect(60, 200, 401, 71))
...
"}")
        ...
        self.caixaGrupos_3 = QtWidgets.QPlainTextEdit(self.frame_17)
        self.caixaGrupos_3.setGeometry(QtCore.QRect(50, 340, 451, 41))
        self.caixaGrupos_3.setDisabled(True)
        self.caixaGrupos_3.setMinimumSize(QtCore.QSize(200, 0))
        self.caixaGrupos_3.setStyleSheet("background-color: rgba(0,0,0,0);\n"
"font: 10pt \"MS Shell Dlg 2\";\n"
"border:none;\n"
"color: rgb(255, 255, 255);\n"
"border-bottom:3px solid rgb(250, 250,250);\n"
...
"line-height: 1.1;\n"
"word-spacing: 10px;")
        self.caixaGrupos_3.setObjectName("caixaGrupos_3")
        self.radioContato_3 = QtWidgets.QRadioButton(self.frame_17)
        self.radioContato_3.setGeometry(QtCore.QRect(50, 80, 95, 21))
...
"background-color: rgba(255, 255, 255, 0);")
        ...
        self.botaoAddContato_3.setGeometry(QtCore.QRect(90, 260, 131, 31))
...
"background-color: rgba(255, 255, 255, 0);")
        ...
        self.label_60.setGeometry(QtCore.QRect(50, 40, 441, 29))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
...
"background-color: rgba(255, 255, 255, 0);")
        ...
        self.caixaContato_3 = QtWidgets.QPlainTextEdit(self.frame_17)
        self.caixaContato_3.setGeometry(QtCore.QRect(50, 130, 451, 41))
        self.caixaContato_3.setMinimumSize(QtCore.QSize(200, 0))
        self.caixaContato_3.setDisabled(True)
        self.caixaContato_3.setStyleSheet("background-color: rgba(0,0,0,0);\n"
"font: 10pt \"MS Shell Dlg 2\";\n"
"border:none;\n"
"color: rgb(255, 255, 255);\n"
"border-bottom:3px solid rgb(250, 250,250);\n"
...
"line-height: 1.1;\n"
"word-spacing: 10px;")
        self.caixaContato_3.setObjectName("caixaContato_3")
        self.listaContatos_3 = QtWidgets.QListWidget(self.frame_17)
        self.listaContatos_3.setGeometry(QtCore.QRect(50, 180, 641, 71))
        self.listaContatos_3.doubleClicked.connect(self.eliminarItemListaContatos)
...
"}")
        ...
        self.listaGrupos_3 = QtWidgets.QListWidget(self.frame_17)
        self.listaGrupos_3.setGeometry(QtCore.QRect(50, 390, 641, 71))
        self.listaGrupos_3.doubleClicked.connect(self.eliminarItemListaGrupos)
        self.listaGrupos_3.setStyleSheet("QListWidget\n"
"{\n"
"border : 3px solid rgb(255,255,255);\n"
"border-radius:12%;\n"
"color:white;\n"
...
"background:rgb(85, 0, 127)\n"
"}")
        self.listaGrupos_3.setDragDropMode(QtWidgets.QAbstractItemView.InternalMove)
        self.listaGrupos_3.setObjectName("listaGrupos_3")
        self.botaoSalvarContato_3 = QtWidgets.QPushButton(self.frame_17)
        self.botaoSalvarContato_3.setGeometry(QtCore.QRect(510, 130, 161, 41))
        self.botaoSalvarContato_3.clicked.connect(self.salvar_ctt)
        self.botaoSalvarContato_3.setDisabled(True)
        self.botaoSalvarContato_3.setStyleSheet("QPushButton{\n"
"    background-color: rgb(145, 70, 255);\n"
"    color:white;\n"
"    font:87 8pt \"Arial Black\";\n"
"    background-color: rgb(145, 70, 255);\n"
...
"color: (145, 70, 255);\n"
"}")
        self.botaoSalvarContato_3.setObjectName("botaoSalvarContato_3")
        ...
        # self.stackedWidget_3.currentChanged.connect(self.__verificar)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
        ...
        self.botaoSalvarGrupo_3 = QtWidgets.QPushButton(self.frame_17)
        self.botaoSalvarGrupo_3.setGeometry(QtCore.QRect(520, 340, 161, 41))
        self.botaoSalvarGrupo_3.clicked.connect(self.salvar_gpp)
        self.botaoSalvarGrupo_3.setDisabled(True)
        self.botaoSalvarGrupo_3.setStyleSheet("QPushButton{\n"
"    \n"
"    background-color: rgb(145, 70, 255);\n"
"    border-radius:10px;\n"
"    padding: 5px;\n"
...
"color: (145, 70, 255);\n"
"}")
        self.botaoSalvarGrupo_3.setObjectName("botaoSalvarGrupo_3")
...
"}")
        ...
        self.botaoInfo_2.setGeometry(QtCore.QRect(50, 260, 31, 31))
...
"")
        ...
        self.botaoInfo_3.setGeometry(QtCore.QRect(50, 470, 31, 31))
...
"}")
        ...
        self.botaoAddGrupo_4.setGeometry(QtCore.QRect(90, 470, 131, 31))
        self.botaoAddGrupo_4.setDisabled(True)
...
"}")
        ...
        self.botaoInfo_1.setGeometry(QtCore.QRect(300, 40, 31, 31))
...
"padding-bottom:7px;\n")
        ...
        self.caixaNomePersonalizado_4.setObjectName("caixaNumeroPersonalizado_4")
...
"}")
        ...
        self.widgetAddGrupo.setGeometry(QtCore.QRect(228, 470, 261, 71))
        self.widgetAddGrupo.setVisible(False)
        self.widgetAddGrupo.setStyleSheet("background-color: rgb(145, 70, 255);\n"
"border-radius:10%\n"
"")
        self.widgetAddGrupo.setObjectName("widget_2")
...
"}")
        ...
        self.botaoSelecionarContato = QtWidgets.QPushButton(self.frame_17)
        self.botaoSelecionarContato.setGeometry(QtCore.QRect(230, 260, 131, 31))
        self.botaoSelecionarContato.setDisabled(True)
        self.botaoSelecionarContato.clicked.connect(self.abrirPopupSelecionarContato)
        self.botaoSelecionarContato.setStyleSheet("QPushButton{\n"
"    \n"
"    background-color: rgb(145, 70, 255);\n"
"    border-radius:10px;\n"
"    padding: 5px;\n"
...
"color: (145, 70, 255);\n"
"}")
        self.botaoSelecionarContato.setObjectName("botaoSelecionarContato")
        self.widgetSelecionarContato = QtWidgets.QWidget(self.frame_17)
        self.widgetSelecionarContato.setGeometry(QtCore.QRect(369, 260, 291, 111))
        self.widgetSelecionarContato.setVisible(False)
        self.widgetSelecionarContato.setStyleSheet("background-color: rgb(145, 70, 255);\n"
"border-radius:10%\n"
"")
        self.widgetSelecionarContato.setObjectName("widgetSelecionarContato")
        self.botaoFecharSelecionarContatos = QtWidgets.QPushButton(self.widgetSelecionarContato)
        self.botaoFecharSelecionarContatos.setGeometry(QtCore.QRect(260, 5, 21, 21))
        self.botaoFecharSelecionarContatos.clicked.connect(self.abrirPopupSelecionarContato)
        self.botaoFecharSelecionarContatos.setStyleSheet("QPushButton{\n"
"    \n"
"    background-color: rgb(255, 255, 255);\n"
"    border-radius:10px;\n"
"    padding: 5px;\n"
...
"color: (145, 70, 255);\n"
"}")
        self.botaoFecharSelecionarContatos.setObjectName("botaoFecharSelecionarContatos")
        self.listaContatosSelecionar = QtWidgets.QListWidget(self.widgetSelecionarContato)
        self.listaContatosSelecionar.setGeometry(QtCore.QRect(10, 10, 241, 91))
        self.listaContatosSelecionar.doubleClicked.connect(self.cliqueDuploSelecionarContato)
        self.listaContatosSelecionar.setStyleSheet("QListWidget\n"
"{\n"
"border : 3px solid rgb(255,255,255);\n"
"border-radius:12%;\n"
"color:white;\n"
...
"background:rgb(85, 0, 127)\n"
"}")
        self.listaContatosSelecionar.setDragDropMode(QtWidgets.QAbstractItemView.InternalMove)
        self.listaContatosSelecionar.setObjectName("listaContatosSelecionar")
        self.botaoSelecionarGrupo = QtWidgets.QPushButton(self.frame_17)
        self.botaoSelecionarGrupo.setGeometry(QtCore.QRect(230, 470, 131, 31))
        self.botaoSelecionarGrupo.setDisabled(True)
        self.botaoSelecionarGrupo.clicked.connect(self.abrirPopupSelecionarGrupo)
        self.botaoSelecionarGrupo.setStyleSheet("QPushButton{\n"
"    \n"
"    background-color: rgb(145, 70, 255);\n"
"    border-radius:10px;\n"
"    padding: 5px;\n"
...
"color: (145, 70, 255);\n"
"}")
        self.botaoSelecionarGrupo.setObjectName("botaoSelecionarGrupo")
        self.widgetSelecionarGrupo = QtWidgets.QWidget(self.frame_17)
        self.widgetSelecionarGrupo.setGeometry(QtCore.QRect(370, 470, 291, 81))
        self.widgetSelecionarGrupo.setVisible(False)
        self.widgetSelecionarGrupo.setStyleSheet("background-color: rgb(145, 70, 255);\n"
                                                 "border-radius:10%\n"
                                                 "")
        self.widgetSelecionarGrupo.setObjectName("widgetSelecionarGrupo")
        self.botaoFecharSelecionarGrupo = QtWidgets.QPushButton(self.widgetSelecionarGrupo)
        self.botaoFecharSelecionarGrupo.setGeometry(QtCore.QRect(260, 5, 21, 21))
        self.botaoFecharSelecionarGrupo.clicked.connect(self.abrirPopupSelecionarGrupo)
        self.botaoFecharSelecionarGrupo.setStyleSheet("QPushButton{\n"
"    \n"
"    background-color: rgb(255, 255, 255);\n"
"    border-radius:10px;\n"
"    padding: 5px;\n"
...
"color: (145, 70, 255);\n"
"}")
        self.botaoFecharSelecionarGrupo.setObjectName("botaoFecharSelecionarGrupo")
        self.listaGrupoSelecionar = QtWidgets.QListWidget(self.widgetSelecionarGrupo)
        self.listaGrupoSelecionar.setGeometry(QtCore.QRect(10, 10, 241, 61))
        self.listaGrupoSelecionar.doubleClicked.connect(self.salvar_gpp)
        self.listaGrupoSelecionar.setStyleSheet("QListWidget\n"
"{\n"
"border : 3px solid rgb(255,255,255);\n"
"border-radius:12%;\n"
"color:white;\n"
...
"background:rgb(85, 0, 127)\n"
"}")
        self.listaGrupoSelecionar.setDragDropMode(QtWidgets.QAbstractItemView.InternalMove)
        self.listaGrupoSelecionar.setObjectName("listaGrupoSelecionar")
        self.botaoSelecionarGrupo.raise_()
        self.caixaGrupos_3.raise_()
        self.radioContato_3.raise_()
        self.botaoAddContato_3.raise_()
        self.radioGrupo_3.raise_()
        self.label_60.raise_()
        self.caixaContato_3.raise_()
        self.listaContatos_3.raise_()
        self.listaGrupos_3.raise_()
        self.botaoSalvarContato_3.raise_()
        self.botaoAvan2_3.raise_()
        self.botaoSalvarGrupo_3.raise_()
        self.botaoRetro1_3.raise_()
        self.botaoInfo_2.raise_()
        self.botaoInfo_3.raise_()
        self.botaoAddGrupo_4.raise_()
        self.botaoInfo_1.raise_()
        self.botaoSelecionarContato.raise_()
        self.widgetAddContato.raise_()
        self.widgetSelecionarContato.raise_()
        self.widgetAddGrupo.raise_()
        self.widgetSelecionarGrupo.raise_()
...
"}")
        ...
        self.calendario_3 = QtWidgets.QCalendarWidget(self.frame_18)
        self.calendario_3.setGeometry(QtCore.QRect(380, 40, 351, 281))
...
"")
        ...
        self.label_64.setGeometry(QtCore.QRect(404, 360, 171, 32))
        self.label_64.setStyleSheet("font:87 10pt \"Arial Black\";\n"
"color: rgb(255, 255, 255);")
        self.label_64.setObjectName("label_64")
        self.timeHorario_3 = QtWidgets.QTimeEdit(self.frame_18)
        self.timeHorario_3.setGeometry(QtCore.QRect(176, 100, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(8)
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(10)
        self.timeHorario_3.setFont(font)
        self.timeHorario_3.setStyleSheet("background-color: rgb(145, 70, 255);\n"
"border-radius: 5px;\n"
...
"    color:white;\n"
"    font:87 8pt \"Arial Black\";")
        self.timeHorario_3.setWrapping(False)
        self.timeHorario_3.setFrame(False)
        self.timeHorario_3.setAlignment(QtCore.Qt.AlignCenter)
        self.timeHorario_3.setReadOnly(False)
        self.timeHorario_3.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.timeHorario_3.setAccelerated(False)
        self.timeHorario_3.setCorrectionMode(QtWidgets.QAbstractSpinBox.CorrectToPreviousValue)
        self.timeHorario_3.setKeyboardTracking(True)
        self.timeHorario_3.setProperty("showGroupSeparator", False)
        self.timeHorario_3.setCalendarPopup(False)
        self.timeHorario_3.setObjectName("timeHorario_3")
        self.label_65 = QtWidgets.QLabel(self.frame_18)
        self.label_65.setGeometry(QtCore.QRect(41, 48, 130, 24))
        self.label_65.setStyleSheet("font:87 10pt \"Arial Black\";\n"
"color: rgb(255, 255, 255);")
        self.label_65.setObjectName("label_65")
        self.label_66 = QtWidgets.QLabel(self.frame_18)
        self.label_66.setGeometry(QtCore.QRect(86, 102, 75, 24))
        self.label_66.setStyleSheet("font:87 10pt \"Arial Black\";\n"
"color: rgb(255, 255, 255);")
        self.label_66.setObjectName("label_66")
        self.comboTipoDeEnvio_3 = QtWidgets.QComboBox(self.frame_18)
        self.comboTipoDeEnvio_3.setGeometry(QtCore.QRect(181, 45, 149, 30))
...
"}")
        ...
        self.comboTipoDeEnvio_3.addItem("")
        self.comboTipoDeEnvio_3.addItem("")
        self.widget_24 = QtWidgets.QWidget(self.frame_18)
        self.widget_24.setGeometry(QtCore.QRect(41, 160, 301, 331))
...
"}")
        ...
        self.listaDiasPersonalizado_3.setGeometry(QtCore.QRect(10, 160, 281, 161))
...
"}")
        ...
        self.listaDiasSelecionados_3 = QtWidgets.QListWidget(self.frame_18)
        self.listaDiasSelecionados_3.setGeometry(QtCore.QRect(381, 390, 361, 91))
...
"}")
        ...
        self.botaoAdicionarDiaCalendario = QtWidgets.QPushButton(self.frame_18)
        self.botaoAdicionarDiaCalendario.setGeometry(QtCore.QRect(510, 330, 81, 31))
...
"color: rgba(255, 255, 255, 150);")
        ...
        self.widget_28.setGeometry(QtCore.QRect(0, 260, 531, 81))
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.botaoAddConteudo_3.setText(_translate("Form", "Adicionar Conteúdo"))
        ...
        self.botaoSalvar_3.setText(_translate("Form", "Salvar"))
        self.botaoAvan1_3.setText(_translate("Form", ">"))
        self.botaoFecharSelecionarContatos.setText(_translate("Form", "X"))
        self.botaoFecharSelecionarGrupo.setText(_translate("Form", "X"))
        ...
        self.botaoSelecionarContato.setText(_translate("Form", "Selecionar Contato"))
        self.botaoSelecionarGrupo.setText(_translate("Form", "Selecionar Grupo"))
        ...
        self.caixaGrupos_3.setPlaceholderText(_translate("Form", "Grupo"))
        ...
        self.caixaContato_3.setPlaceholderText(_translate("Form", "Contato"))
        self.botaoSalvarContato_3.setText(_translate("Form", "Salvar contato"))
        self.botaoAvan2_3.setText(_translate("Form", ">"))
        self.botaoSalvarGrupo_3.setText(_translate("Form", "Salvar Grupo"))
        self.botaoRetro1_3.setText(_translate("Form", "<"))
        self.botaoInfo_2.setToolTip(_translate("Form", "* Ordem de encaminhamento de mensagens por contato, informar diretamente o número do remetente ou adicionar seu contato"))
        self.botaoInfo_2.setText(_translate("Form", "?"))
        self.botaoInfo_3.setToolTip(_translate("Form", "* Ordem de encaminhamento de mensagens por grupo"))
    ...
    def __gravar(self):
        ...
        if nomeValido:
                ...
                resetarRotinas(cursor=self.cursor)
    ...
    def __coletarDados(self):
        ...
        # self.Dias
        self.horario = self.timeHorario_3.time().toString()[:5]
        self.mensagensFormatadas = []
        ...
        if self.tipo_Remetente == 'Contato':
            for i in range(0, self.listaContatos_3.count()):
                try:
                    print(self.contatosENumeros[self.listaContatos_3.item(i).text()])
                    numerosContatos.append(self.contatosENumeros[self.listaContatos_3.item(i).text()])
                except:
                    numerosContatos.append(self.listaContatos_3.item(i).text())
                print(numerosContatos)
        elif self.tipo_Remetente == 'Grupo':
            for i in range(0, self.listaGrupos_3.count()):
                nomesGrupos.append(self.listaGrupos_3.item(i).text())
                print(nomesGrupos)
                ...
                for j in range(0, self.listaVariaveis_3.count()):
                    ...
                    if f'({variavel})' in msg:
                        if variavel == 'Nome do destinatário':
                            msg = msg.replace(f'({variavel})', 'JONAS')
    ...
    def cliqueDuploSelecionarContato(self):

        self.listaContatos_3.addItem(self.listaContatosSelecionar.currentItem().text())
        # self.listaContatosSelecionar.removeItem()
        # self.listaContatosSelecionar.removeItemWidget(aItem=self.listaContatos_3.currentItem())
    ...
    def __verificar(self):
        ...
        if tipo_RemetenteCtt is False and tipo_RemetenteGpp is False and currentIndex == 1:
            ...
            if self.listaContatos_3.count() == 0 and self.tipo_Remetente == 'Contato':
                self.__popupErro('Erro em contatos', 'Não há nenhum contato selecionado para envio\nInforme o contato')
                return False
            elif self.listaGrupos_3.count() == 0 and self.tipo_Remetente == 'Grupo':
                self.__popupErro('Erro em grupos',
                                     'Não há nenhum grupo selecionado para envio\nInforme o grupo')
                return False
    ...
    def salvar_gpp(self):
        grupo = self.caixaGrupos_3.toPlainText()
        self.listaGrupos_3.addItem(grupo)
    ...
    def salvar_ctt(self):
        ctt = self.caixaContato_3.toPlainText()
        verificacao = self.__verificarNumero(ctt)

        if verificacao:
            self.listaContatos_3.addItem(verificacao[1])
        else:
            self.__popupErro('Erro de digitação', f'O padrão aceito é\n55 47 9999-9999\nDigitado:\n{ctt}')
    ...
    def __preencherGrupos(self):
        ...
        try:
            self.listaGrupoSelecionar.clear()
            self.cursor.execute('SELECT nome FROM Grupos')
            for elemento in self.cursor.fetchall():
                print(elemento[0])
                self.listaGrupoSelecionar.addItem(str(elemento[0]))
        except:
    ...
    def abrirPopupSelecionarContato(self):
        if self.widgetSelecionarContato.isVisible():
            self.widgetSelecionarContato.setVisible(False)
        else:
            self.widgetSelecionarContato.setVisible(True)

        self.__preencherContatos()


    def abrirPopupSelecionarGrupo(self):
        if self.widgetSelecionarGrupo.isVisible():
            self.widgetSelecionarGrupo.setVisible(False)
        else:
            self.widgetSelecionarGrupo.setVisible(True)
    ...
    def eliminarItemListaGrupos(self):
        item = self.listaGrupos_3.currentItem()
        self.listaGrupos_3.takeItem(self.listaGrupos_3.indexFromItem(item).row())
    ...
    def checkGrupo(self):
        if self.listaContatos_3.isEnabled() == True:
            self.listaContatos_3.setDisabled(True)
            self.botaoSalvarGrupo_3.setDisabled(True)
            self.caixaContato_3.setDisabled(True)
            self.botaoAddContato_3.setDisabled(True)
            self.botaoSalvarContato_3.setDisabled(True)
            self.caixaGrupos_3.setDisabled(False)
            self.listaGrupos_3.setDisabled(False)
            self.botaoSalvarGrupo_3.setDisabled(False)
            self.botaoAddGrupo_4.setDisabled(False)
            self.botaoSelecionarGrupo.setDisabled(False)
            self.botaoSelecionarContato.setDisabled(True)



    def checkContato(self):
        if self.listaGrupos_3.isEnabled() == True:
            self.listaContatos_3.setDisabled(False)
            self.botaoSalvarGrupo_3.setDisabled(False)
            self.caixaContato_3.setDisabled(False)
            self.botaoAddContato_3.setDisabled(False)
            self.botaoSalvarContato_3.setDisabled(False)
            self.caixaGrupos_3.setDisabled(True)
            self.listaGrupos_3.setDisabled(True)
            self.botaoSalvarGrupo_3.setDisabled(True)
            self.botaoAddGrupo_4.setDisabled(True)
            self.botaoSelecionarGrupo.setDisabled(True)
            self.botaoSelecionarContato.setDisabled(False)
